...
// Validate checks the field values on AddRestrictedProjectMemberRequest with
// the rules defined in the proto definition for this message. If any rules
// are violated, the first error encountered is returned, or nil if there are
// no violations.
func (m *AddRestrictedProjectMemberRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on AddRestrictedProjectMemberRequest
// with the rules defined in the proto definition for this message. If any
// rules are violated, the result is a list of violation errors wrapped in
// AddRestrictedProjectMemberRequestMultiError, or nil if none found.
func (m *AddRestrictedProjectMemberRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *AddRestrictedProjectMemberRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if utf8.RuneCountInString(m.GetOrganization()) < 1 {
		err := AddRestrictedProjectMemberRequestValidationError{
			field:  "Organization",
			reason: "value length must be at least 1 runes",
		}
		if !all {
	...
	if len(errors) > 0 {
		return AddRestrictedProjectMemberRequestMultiError(errors)
	}

	return nil
}

func (m *AddRestrictedProjectMemberRequest) _validateHostname(host string) error {
	s := strings.ToLower(strings.TrimSuffix(host, "."))
...
func (m *AddRestrictedProjectMemberRequest) _validateEmail(addr string) error {
	a, err := mail.ParseAddress(addr)
	if err != nil {
		return err
	}
...
// AddRestrictedProjectMemberRequestMultiError is an error wrapping multiple
// validation errors returned by
// AddRestrictedProjectMemberRequest.ValidateAll() if the designated
// constraints aren't met.
type AddRestrictedProjectMemberRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m AddRestrictedProjectMemberRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m AddRestrictedProjectMemberRequestMultiError) AllErrors() []error { return m }

// AddRestrictedProjectMemberRequestValidationError is the validation error
// returned by AddRestrictedProjectMemberRequest.Validate if the designated
// constraints aren't met.
type AddRestrictedProjectMemberRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e AddRestrictedProjectMemberRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e AddRestrictedProjectMemberRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e AddRestrictedProjectMemberRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e AddRestrictedProjectMemberRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e AddRestrictedProjectMemberRequestValidationError) ErrorName() string {
	return "AddRestrictedProjectMemberRequestValidationError"
}

// Error satisfies the builtin error interface
func (e AddRestrictedProjectMemberRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sAddRestrictedProjectMemberRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = AddRestrictedProjectMemberRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = AddRestrictedProjectMemberRequestValidationError{}
...
func (m *SetProjectMemberRoleRequest) validate(all bool) error {
	...
	// no validation rules for IsRestricted
...
// Validate checks the field values on CreateProjectRestrictedRoleRequest with
// the rules defined in the proto definition for this message. If any rules
// are violated, the first error encountered is returned, or nil if there are
// no violations.
func (m *CreateProjectRestrictedRoleRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on CreateProjectRestrictedRoleRequest
// with the rules defined in the proto definition for this message. If any
// rules are violated, the result is a list of violation errors wrapped in
// CreateProjectRestrictedRoleRequestMultiError, or nil if none found.
func (m *CreateProjectRestrictedRoleRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *CreateProjectRestrictedRoleRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if utf8.RuneCountInString(m.GetOrganization()) < 1 {
		err := CreateProjectRestrictedRoleRequestValidationError{
			field:  "Organization",
			reason: "value length must be at least 1 runes",
		}
		if !all {
	...
	for idx, item := range m.GetAttributes() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, CreateProjectRestrictedRoleRequestValidationError{
			...
			if err := v.Validate(); err != nil {
				return CreateProjectRestrictedRoleRequestValidationError{
					field:  fmt.Sprintf("Attributes[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return CreateProjectRestrictedRoleRequestMultiError(errors)
	}

	return nil
}

// CreateProjectRestrictedRoleRequestMultiError is an error wrapping multiple
// validation errors returned by
// CreateProjectRestrictedRoleRequest.ValidateAll() if the designated
// constraints aren't met.
type CreateProjectRestrictedRoleRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CreateProjectRestrictedRoleRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CreateProjectRestrictedRoleRequestMultiError) AllErrors() []error { return m }

// CreateProjectRestrictedRoleRequestValidationError is the validation error
// returned by CreateProjectRestrictedRoleRequest.Validate if the designated
// constraints aren't met.
type CreateProjectRestrictedRoleRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CreateProjectRestrictedRoleRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CreateProjectRestrictedRoleRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CreateProjectRestrictedRoleRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CreateProjectRestrictedRoleRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CreateProjectRestrictedRoleRequestValidationError) ErrorName() string {
	return "CreateProjectRestrictedRoleRequestValidationError"
}

// Error satisfies the builtin error interface
func (e CreateProjectRestrictedRoleRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCreateProjectRestrictedRoleRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = CreateProjectRestrictedRoleRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = CreateProjectRestrictedRoleRequestValidationError{}

// Validate checks the field values on CreateProjectRestrictedRoleResponse with
// the rules defined in the proto definition for this message. If any rules
// are violated, the first error encountered is returned, or nil if there are
// no violations.
func (m *CreateProjectRestrictedRoleResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on CreateProjectRestrictedRoleResponse
// with the rules defined in the proto definition for this message. If any
// rules are violated, the result is a list of violation errors wrapped in
// CreateProjectRestrictedRoleResponseMultiError, or nil if none found.
func (m *CreateProjectRestrictedRoleResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *CreateProjectRestrictedRoleResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return CreateProjectRestrictedRoleResponseMultiError(errors)
	}

	return nil
}

// CreateProjectRestrictedRoleResponseMultiError is an error wrapping multiple
// validation errors returned by
// CreateProjectRestrictedRoleResponse.ValidateAll() if the designated
// constraints aren't met.
type CreateProjectRestrictedRoleResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CreateProjectRestrictedRoleResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CreateProjectRestrictedRoleResponseMultiError) AllErrors() []error { return m }

// CreateProjectRestrictedRoleResponseValidationError is the validation error
// returned by CreateProjectRestrictedRoleResponse.Validate if the designated
// constraints aren't met.
type CreateProjectRestrictedRoleResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CreateProjectRestrictedRoleResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CreateProjectRestrictedRoleResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CreateProjectRestrictedRoleResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CreateProjectRestrictedRoleResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CreateProjectRestrictedRoleResponseValidationError) ErrorName() string {
	return "CreateProjectRestrictedRoleResponseValidationError"
}

// Error satisfies the builtin error interface
func (e CreateProjectRestrictedRoleResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCreateProjectRestrictedRoleResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = CreateProjectRestrictedRoleResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = CreateProjectRestrictedRoleResponseValidationError{}

// Validate checks the field values on RestrictedRoleAttribute with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *RestrictedRoleAttribute) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on RestrictedRoleAttribute with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// RestrictedRoleAttributeMultiError, or nil if none found.
func (m *RestrictedRoleAttribute) ValidateAll() error {
	return m.validate(true)
}

func (m *RestrictedRoleAttribute) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if utf8.RuneCountInString(m.GetKey()) < 1 {
		err := RestrictedRoleAttributeValidationError{
			field:  "Key",
			reason: "value length must be at least 1 runes",
		}
		if !all {
	...
	if len(errors) > 0 {
		return RestrictedRoleAttributeMultiError(errors)
	}

	return nil
}

// RestrictedRoleAttributeMultiError is an error wrapping multiple validation
// errors returned by RestrictedRoleAttribute.ValidateAll() if the designated
// constraints aren't met.
type RestrictedRoleAttributeMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m RestrictedRoleAttributeMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m RestrictedRoleAttributeMultiError) AllErrors() []error { return m }

// RestrictedRoleAttributeValidationError is the validation error returned by
// RestrictedRoleAttribute.Validate if the designated constraints aren't met.
type RestrictedRoleAttributeValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e RestrictedRoleAttributeValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e RestrictedRoleAttributeValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e RestrictedRoleAttributeValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e RestrictedRoleAttributeValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e RestrictedRoleAttributeValidationError) ErrorName() string {
	return "RestrictedRoleAttributeValidationError"
}

// Error satisfies the builtin error interface
func (e RestrictedRoleAttributeValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sRestrictedRoleAttribute.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = RestrictedRoleAttributeValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = RestrictedRoleAttributeValidationError{}
...
func (m *ProjectPermissions) validate(all bool) error {
	...
	for idx, item := range m.GetRestrictedRoles() {
		_, _ = idx, item
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, ProjectPermissionsValidationError{
						field:  fmt.Sprintf("RestrictedRoles[%v]", idx),
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
...
// Validate checks the field values on RestrictedRole with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *RestrictedRole) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on RestrictedRole with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in RestrictedRoleMultiError,
// or nil if none found.
func (m *RestrictedRole) ValidateAll() error {
	return m.validate(true)
}

func (m *RestrictedRole) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetAttributes() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, RestrictedRoleValidationError{
						field:  fmt.Sprintf("Attributes[%v]", idx),
						reason: "embedded message failed validation",
						cause:  err,
					})
			...
			if err := v.Validate(); err != nil {
				return RestrictedRoleValidationError{
					field:  fmt.Sprintf("Attributes[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return RestrictedRoleMultiError(errors)
	}

	return nil
}

// RestrictedRoleMultiError is an error wrapping multiple validation errors
// returned by RestrictedRole.ValidateAll() if the designated constraints
// aren't met.
type RestrictedRoleMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m RestrictedRoleMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m RestrictedRoleMultiError) AllErrors() []error { return m }

// RestrictedRoleValidationError is the validation error returned by
// RestrictedRole.Validate if the designated constraints aren't met.
type RestrictedRoleValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e RestrictedRoleValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e RestrictedRoleValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e RestrictedRoleValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e RestrictedRoleValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e RestrictedRoleValidationError) ErrorName() string { return "RestrictedRoleValidationError" }

// Error satisfies the builtin error interface
func (e RestrictedRoleValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = RestrictedRoleValidationError{}
