...
const (
	...
	MetricsViewSpec_DIMENSION_TYPE_GEOSPATIAL  MetricsViewSpec_DimensionType = 3
)
...
type ModelState struct {
	...
	RowsTotal int64 `protobuf:"varint,14,opt,name=rows_total,json=rowsTotal,proto3" json:"rows_total,omitempty"`
	// bytes_total is the total size in bytes of the model's output table.
	BytesTotal int64 `protobuf:"varint,15,opt,name=bytes_total,json=bytesTotal,proto3" json:"bytes_total,omitempty"`
}
...
func (x *ModelState) GetRowsTotal() int64 {
	if x != nil {
		return x.RowsTotal
	}
	return 0
...
func (x *ModelState) GetBytesTotal() int64 {
	if x != nil {
		return x.BytesTotal
	}
	return 0
...
type MetricsViewSpec struct {
	...
	QueryAttributes map[string]string              `protobuf:"bytes,33,rep,name=query_attributes,json=queryAttributes,proto3" json:"query_attributes,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Rollups         []*MetricsViewSpec_RollupTable `protobuf:"bytes,34,rep,name=rollups,proto3" json:"rollups,omitempty"`
}
...
func (x *MetricsViewSpec) GetQueryAttributes() map[string]string {
	if x != nil {
...
func (x *MetricsViewSpec) GetRollups() []*MetricsViewSpec_RollupTable {
	if x != nil {
		return x.Rollups
	}
	return nil
...
type ExplorePreset struct {
	...
	TimeDimension   *string `protobuf:"bytes,34,opt,name=time_dimension,json=timeDimension,proto3,oneof" json:"time_dimension,omitempty"`
	// Comparison mode.
	...
	PivotRowLimit                               *int32   `protobuf:"varint,33,opt,name=pivot_row_limit,json=pivotRowLimit,proto3,oneof" json:"pivot_row_limit,omitempty"`
}
...
func (x *ExplorePreset) GetTimeDimension() string {
	if x != nil && x.TimeDimension != nil {
		return *x.TimeDimension
	}
	return ""
}
...
func (x *ExplorePreset) GetPivotRowLimit() int32 {
	if x != nil && x.PivotRowLimit != nil {
		return *x.PivotRowLimit
	}
	return 0
}
...
type ReportSpec struct {
	...
	Resolver           string           `protobuf:"bytes,17,opt,name=resolver,proto3" json:"resolver,omitempty"`
	ResolverProperties *structpb.Struct `protobuf:"bytes,18,opt,name=resolver_properties,json=resolverProperties,proto3" json:"resolver_properties,omitempty"`
...
func (x *ReportSpec) GetResolver() string {
	if x != nil {
		return x.Resolver
	}
	return ""
...
func (x *ReportSpec) GetResolverProperties() *structpb.Struct {
	if x != nil {
		return x.ResolverProperties
	}
	return nil
...
type CanvasSpec struct {
	...
	PinnedFilters []string `protobuf:"bytes,16,rep,name=pinned_filters,json=pinnedFilters,proto3" json:"pinned_filters,omitempty"`
}
...
func (x *CanvasSpec) GetPinnedFilters() []string {
	if x != nil {
		return x.PinnedFilters
	}
	return nil
}
...
type CanvasPreset struct {
	...
	FilterExpr map[string]*DefaultMetricsSQLFilter `protobuf:"bytes,19,rep,name=filter_expr,json=filterExpr,proto3" json:"filter_expr,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *CanvasPreset) GetFilterExpr() map[string]*DefaultMetricsSQLFilter {
	if x != nil {
		return x.FilterExpr
	}
	return nil
...
type DefaultMetricsSQLFilter struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *DefaultMetricsSQLFilter) Reset() {
	*x = DefaultMetricsSQLFilter{}
	if protoimpl.UnsafeEnabled {
...
func (x *DefaultMetricsSQLFilter) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DefaultMetricsSQLFilter) ProtoMessage() {}

func (x *DefaultMetricsSQLFilter) ProtoReflect() protoreflect.Message {
	mi := &file_rill_runtime_v1_resources_proto_msgTypes[60]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DefaultMetricsSQLFilter.ProtoReflect.Descriptor instead.
func (*DefaultMetricsSQLFilter) Descriptor() ([]byte, []int) {
	return file_rill_runtime_v1_resources_proto_rawDescGZIP(), []int{60}
}

func (x *DefaultMetricsSQLFilter) GetExpression() *Expression {
	if x != nil {
		return x.Expression
	}
	return nil
...
func (x *ParseError) GetWarning() bool {
	if x != nil {
		return x.Warning
	}
	return false
...
func (x *MetricsViewSpec_Dimension) GetTags() []string {
	if x != nil {
		return x.Tags
	}
	return nil
...
func (x *MetricsViewSpec_Measure) GetTags() []string {
	if x != nil {
		return x.Tags
	}
	return nil
...
type MetricsViewSpec_RollupTable struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	DatabaseSchema string                           `protobuf:"bytes,3,opt,name=database_schema,json=databaseSchema,proto3" json:"database_schema,omitempty"`
	...
	Dimensions     []string                         `protobuf:"bytes,7,rep,name=dimensions,proto3" json:"dimensions,omitempty"`
	Measures       []*MetricsViewSpec_RollupMeasure `protobuf:"bytes,8,rep,name=measures,proto3" json:"measures,omitempty"`
	Timezone       string                           `protobuf:"bytes,9,opt,name=timezone,proto3" json:"timezone,omitempty"`                               // IANA timezone the rollup was aggregated in; defaults to UTC
	TimeColumn     string                           `protobuf:"bytes,10,opt,name=time_column,json=timeColumn,proto3" json:"time_column,omitempty"`        // column name for the time dimension in the rollup table (overrides the base time dimension column)
	IsProjection   bool                             `protobuf:"varint,11,opt,name=is_projection,json=isProjection,proto3" json:"is_projection,omitempty"` // if true, query targets the base table; WHERE uses date_trunc for projection matching
}

func (x *MetricsViewSpec_RollupTable) Reset() {
	*x = MetricsViewSpec_RollupTable{}
	if protoimpl.UnsafeEnabled {
...
func (x *MetricsViewSpec_RollupTable) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MetricsViewSpec_RollupTable) ProtoMessage() {}

func (x *MetricsViewSpec_RollupTable) ProtoReflect() protoreflect.Message {
	mi := &file_rill_runtime_v1_resources_proto_msgTypes[79]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MetricsViewSpec_RollupTable.ProtoReflect.Descriptor instead.
func (*MetricsViewSpec_RollupTable) Descriptor() ([]byte, []int) {
	return file_rill_runtime_v1_resources_proto_rawDescGZIP(), []int{14, 6}
}

func (x *MetricsViewSpec_RollupTable) GetConnector() string {
	if x != nil {
		return x.Connector
	}
	return ""
...
func (x *MetricsViewSpec_RollupTable) GetDatabase() string {
	if x != nil {
		return x.Database
	}
	return ""
...
func (x *MetricsViewSpec_RollupTable) GetDatabaseSchema() string {
	if x != nil {
		return x.DatabaseSchema
	}
	return ""
...
func (x *MetricsViewSpec_RollupTable) GetTable() string {
	if x != nil {
		return x.Table
	}
	return ""
...
func (x *MetricsViewSpec_RollupTable) GetModel() string {
	if x != nil {
		return x.Model
	}
	return ""
...
func (x *MetricsViewSpec_RollupTable) GetTimeGrain() TimeGrain {
	if x != nil {
		return x.TimeGrain
	}
	return TimeGrain_TIME_GRAIN_UNSPECIFIED
...
func (x *MetricsViewSpec_RollupTable) GetDimensions() []string {
	if x != nil {
		return x.Dimensions
	}
	return nil
...
func (x *MetricsViewSpec_RollupTable) GetMeasures() []*MetricsViewSpec_RollupMeasure {
	if x != nil {
		return x.Measures
	}
	return nil
...
func (x *MetricsViewSpec_RollupTable) GetTimezone() string {
	if x != nil {
		return x.Timezone
	}
	return ""
...
func (x *MetricsViewSpec_RollupTable) GetTimeColumn() string {
	if x != nil {
		return x.TimeColumn
	}
	return ""
...
func (x *MetricsViewSpec_RollupTable) GetIsProjection() bool {
	if x != nil {
...
type MetricsViewSpec_RollupMeasure struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Name       string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`             // measure name in the metrics view
	Expression string `protobuf:"bytes,2,opt,name=expression,proto3" json:"expression,omitempty"` // SQL expression for re-aggregation (e.g. "SUM(impressions_sum)")
}

func (x *MetricsViewSpec_RollupMeasure) Reset() {
	*x = MetricsViewSpec_RollupMeasure{}
	if protoimpl.UnsafeEnabled {
...
func (x *MetricsViewSpec_RollupMeasure) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MetricsViewSpec_RollupMeasure) ProtoMessage() {}

func (x *MetricsViewSpec_RollupMeasure) ProtoReflect() protoreflect.Message {
	mi := &file_rill_runtime_v1_resources_proto_msgTypes[80]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MetricsViewSpec_RollupMeasure.ProtoReflect.Descriptor instead.
func (*MetricsViewSpec_RollupMeasure) Descriptor() ([]byte, []int) {
	return file_rill_runtime_v1_resources_proto_rawDescGZIP(), []int{14, 7}
}

func (x *MetricsViewSpec_RollupMeasure) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *MetricsViewSpec_RollupMeasure) GetExpression() string {
	if x != nil {
		return x.Expression
	}
	return ""
...
var file_rill_runtime_v1_resources_proto_rawDesc = []byte{
	...
	0x04, 0x08, 0x08, 0x10, 0x09, 0x22, 0xc9, 0x06, 0x0a, 0x0a, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x53,
	...
	0x73, 0x12, 0x1d, 0x0a, 0x0a, 0x72, 0x6f, 0x77, 0x73, 0x5f, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x18,
	0x0e, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x72, 0x6f, 0x77, 0x73, 0x54, 0x6f, 0x74, 0x61, 0x6c,
	0x12, 0x1f, 0x0a, 0x0b, 0x62, 0x79, 0x74, 0x65, 0x73, 0x5f, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x18,
	0x0f, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a, 0x62, 0x79, 0x74, 0x65, 0x73, 0x54, 0x6f, 0x74, 0x61,
	0x6c, 0x22, 0x85, 0x01, 0x0a, 0x09, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x54, 0x65, 0x73, 0x74, 0x12,
	...
	0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x22, 0xe4, 0x20, 0x0a, 0x0f, 0x4d, 0x65, 0x74, 0x72,
	...
	,
	...
	0x69, 0x6f, 0x6e, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x61, 0x67, 0x73, 0x18, 0x10, 0x20, 0x03, 0x28,
	0x09, 0x52, 0x04, 0x74, 0x61, 0x67, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x63, 0x6f, 0x6c, 0x75, 0x6d,
	0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x63, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x12,
	0x1e, 0x0a, 0x0a, 0x65, 0x78, 0x70, 0x72, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x06, 0x20,
	...
	,
	...
	,
	...
	,
	...
	0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x5f, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x53, 0x63,
	0x68, 0x65, 0x6d, 0x61, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x6d, 0x6f,
	0x64, 0x65, 0x6c, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6d, 0x6f, 0x64, 0x65, 0x6c,
	0x12, 0x1a, 0x0a, 0x08, 0x6d, 0x65, 0x61, 0x73, 0x75, 0x72, 0x65, 0x73, 0x18, 0x07, 0x20, 0x03,
	...
	,
	...
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x53,
	0x63, 0x68, 0x65, 0x6d, 0x61, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x6d,
	0x6f, 0x64, 0x65, 0x6c, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6d, 0x6f, 0x64, 0x65,
	0x6c, 0x12, 0x39, 0x0a, 0x0a, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x67, 0x72, 0x61, 0x69, 0x6e, 0x18,
	...
	,
	...
	,
	...
	0x6f, 0x6e, 0x12, 0x27, 0x0a, 0x0f, 0x63, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x5f,
	0x6b, 0x69, 0x6e, 0x64, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0e, 0x63, 0x6f, 0x6e,
	0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x4b, 0x69, 0x6e, 0x64, 0x73, 0x12, 0x4e, 0x0a, 0x13, 0x63,
	0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	...
	0x72, 0x63, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x52, 0x12, 0x63, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69,
	0x6f, 0x6e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x61,
	0x6c, 0x6c, 0x6f, 0x77, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x05, 0x61, 0x6c, 0x6c, 0x6f,
	0x77, 0x12, 0x1c, 0x0a, 0x09, 0x65, 0x78, 0x63, 0x6c, 0x75, 0x73, 0x69, 0x76, 0x65, 0x18, 0x07,
	...
	0x06, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x12, 0x1d, 0x0a, 0x0a, 0x61, 0x6c, 0x6c, 0x5f, 0x66,
	0x69, 0x65, 0x6c, 0x64, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09, 0x61, 0x6c, 0x6c,
	0x46, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x22, 0x92, 0x02, 0x0a, 0x15, 0x53, 0x65, 0x63, 0x75, 0x72,
	0x69, 0x74, 0x79, 0x52, 0x75, 0x6c, 0x65, 0x52, 0x6f, 0x77, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72,
	...
	0x5f, 0x6b, 0x69, 0x6e, 0x64, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0e, 0x63, 0x6f,
	...
	0x63, 0x65, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x72, 0x69, 0x6c, 0x6c,
	...
	,
	...
	,
	...
	,
	...
	0x42, 0x0a, 0x0b, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x72, 0x61, 0x6e, 0x67, 0x65, 0x73, 0x18, 0x09,
	...
	,
	...
	0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x72, 0x69, 0x6c, 0x6c, 0x2e, 0x72, 0x75,
	...
	0x61, 0x73, 0x75, 0x72, 0x65, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x08, 0x6d, 0x65,
	0x61, 0x73, 0x75, 0x72, 0x65, 0x73, 0x12, 0x4b, 0x0a, 0x11, 0x6d, 0x65, 0x61, 0x73, 0x75, 0x72,
	0x65, 0x73, 0x5f, 0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x18, 0x0a, 0x20, 0x01, 0x28,
	...
	,
	...
	0x00, 0x52, 0x05, 0x72, 0x65, 0x67, 0x65, 0x78, 0x12, 0x2d, 0x0a, 0x11, 0x64, 0x75, 0x63, 0x6b,
	0x64, 0x62, 0x5f, 0x65, 0x78, 0x70, 0x72, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x10, 0x64, 0x75, 0x63, 0x6b, 0x64, 0x62, 0x45, 0x78, 0x70,
	0x72, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x42, 0x0a, 0x0a, 0x08, 0x73, 0x65, 0x6c, 0x65, 0x63,
	0x74, 0x6f, 0x72, 0x22, 0x29, 0x0a, 0x0f, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x4c, 0x69, 0x73,
	...
	0x0a, 0x09, 0x4d, 0x69, 0x67, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x32, 0x0a, 0x04, 0x73,
	...
	,
	...
	0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x22, 0x8f, 0x07, 0x0a,
	0x0a, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x53, 0x70, 0x65, 0x63, 0x12, 0x21, 0x0a, 0x0c, 0x64,
	...
	0x07, 0x74, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x12, 0x44, 0x0a, 0x10, 0x72, 0x65, 0x66, 0x72,
	0x65, 0x73, 0x68, 0x5f, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x19, 0x2e, 0x72, 0x69, 0x6c, 0x6c, 0x2e, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d,
	0x65, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x52, 0x0f, 0x72,
	0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x12, 0x27,
	...
	0x53, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x73, 0x12, 0x1a, 0x0a, 0x08, 0x72, 0x65, 0x73, 0x6f, 0x6c,
	0x76, 0x65, 0x72, 0x18, 0x11, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x72, 0x65, 0x73, 0x6f, 0x6c,
	...
	,
	...
	,
	...
	0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x10, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f,
	0x6e, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x27, 0x0a, 0x0f, 0x65, 0x78, 0x65, 0x63,
	0x75, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x0d, 0x52, 0x0e, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x75, 0x6e,
	0x74, 0x22, 0x81, 0x02, 0x0a, 0x0f, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x45, 0x78, 0x65, 0x63,
	0x75, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x14, 0x0a, 0x05, 0x61, 0x64, 0x68, 0x6f, 0x63, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x05, 0x61, 0x64, 0x68, 0x6f, 0x63, 0x12, 0x23, 0x0a, 0x0d, 0x65,
	...
	,
	...
	0x6c, 0x65, 0x12, 0x2b, 0x0a, 0x11, 0x77, 0x61, 0x74, 0x65, 0x72, 0x6d, 0x61, 0x72, 0x6b, 0x5f,
	0x69, 0x6e, 0x68, 0x65, 0x72, 0x69, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x10, 0x77,
	...
	0x5f, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52,
	...
	0x6c, 0x73, 0x5f, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0e,
	...
	0x6b, 0x5f, 0x75, 0x6e, 0x63, 0x6c, 0x6f, 0x73, 0x65, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x16, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x73, 0x43, 0x68, 0x65, 0x63, 0x6b,
	0x55, 0x6e, 0x63, 0x6c, 0x6f, 0x73, 0x65, 0x64, 0x12, 0x27, 0x0a, 0x0f, 0x74, 0x69, 0x6d, 0x65,
	...
	,
	...
	0x14, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x72, 0x69, 0x6c, 0x6c, 0x2e, 0x72, 0x75, 0x6e,
	0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x6c, 0x65, 0x72, 0x74, 0x53, 0x70, 0x65,
	...
	0x0b, 0x0a, 0x09, 0x71, 0x75, 0x65, 0x72, 0x79, 0x5f, 0x66, 0x6f, 0x72, 0x22, 0x61, 0x0a, 0x08,
	0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x12, 0x1c, 0x0a, 0x09, 0x63, 0x6f, 0x6e, 0x6e,
	0x65, 0x63, 0x74, 0x6f, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x63, 0x6f, 0x6e,
	0x6e, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x12, 0x37, 0x0a, 0x0a, 0x70, 0x72, 0x6f, 0x70, 0x65, 0x72,
	...
	,
	...
	,
	...
	,
	...
	0x31, 0x2e, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72,
	0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x22, 0x8f, 0x01, 0x0a,
	0x12, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x53,
	0x70, 0x65, 0x63, 0x12, 0x3b, 0x0a, 0x09, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73,
	...
	0x12, 0x3c, 0x0a, 0x06, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b,
	...
	,
	...
	,
	...
	0x02, 0x38, 0x01, 0x22, 0x76, 0x0a, 0x09, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74,
	0x12, 0x32, 0x0a, 0x04, 0x73, 0x70, 0x65, 0x63, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e,
	0x2e, 0x72, 0x69, 0x6c, 0x6c, 0x2e, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76, 0x31,
	0x2e, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x53, 0x70, 0x65, 0x63, 0x52, 0x04,
	...
	0x6d, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x53,
	0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x22, 0xdc, 0x02, 0x0a, 0x0d,
	0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x53, 0x70, 0x65, 0x63, 0x12, 0x21, 0x0a,
	...
	,
	...
	0x65, 0x64, 0x49, 0x6e, 0x43, 0x61, 0x6e, 0x76, 0x61, 0x73, 0x22, 0x97, 0x01, 0x0a, 0x0e, 0x43,
	0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x3d, 0x0a,
	...
	0x63, 0x52, 0x09, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x53, 0x70, 0x65, 0x63, 0x12, 0x46, 0x0a, 0x11,
	0x64, 0x61, 0x74, 0x61, 0x5f, 0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x65, 0x64, 0x5f, 0x6f,
	0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74,
	0x61, 0x6d, 0x70, 0x52, 0x0f, 0x64, 0x61, 0x74, 0x61, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68,
	0x65, 0x64, 0x4f, 0x6e, 0x22, 0x78, 0x0a, 0x11, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e,
	...
	0x73, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x22, 0xcf, 0x05,
	...
	,
	...
	0x65, 0x73, 0x12, 0x2e, 0x0a, 0x04, 0x72, 0x6f, 0x77, 0x73, 0x18, 0x12, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x1a, 0x2e, 0x72, 0x69, 0x6c, 0x6c, 0x2e, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x2e,
	0x76, 0x31, 0x2e, 0x43, 0x61, 0x6e, 0x76, 0x61, 0x73, 0x52, 0x6f, 0x77, 0x52, 0x04, 0x72, 0x6f,
	0x77, 0x73, 0x12, 0x44, 0x0a, 0x0e, 0x73, 0x65, 0x63, 0x75, 0x72, 0x69, 0x74, 0x79, 0x5f, 0x72,
	0x75, 0x6c, 0x65, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x72, 0x69, 0x6c,
	...
	0x69, 0x74, 0x79, 0x52, 0x75, 0x6c, 0x65, 0x73, 0x12, 0x25, 0x0a, 0x0e, 0x70, 0x69, 0x6e, 0x6e,
	0x65, 0x64, 0x5f, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x18, 0x10, 0x20, 0x03, 0x28, 0x09,
	0x52, 0x0d, 0x70, 0x69, 0x6e, 0x6e, 0x65, 0x64, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x22,
	...
	0x42, 0x08, 0x0a, 0x06, 0x5f, 0x77, 0x69, 0x64, 0x74, 0x68, 0x22, 0x9c, 0x03, 0x0a, 0x0c, 0x43,
	...
	,
	...
	,
	...
	,
	...
	0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x79, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x18, 0x02, 0x20, 0x03,
	0x28, 0x09, 0x52, 0x0c, 0x70, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x79, 0x50, 0x61, 0x74, 0x68,
	0x22, 0x4b, 0x0a, 0x0f, 0x44, 0x65, 0x70, 0x65, 0x6e, 0x64, 0x65, 0x6e, 0x63, 0x79, 0x45, 0x72,
	...
	,
	...
	0x6e, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x53, 0x70, 0x65, 0x63, 0x52, 0x04, 0x73, 0x70, 0x65, 0x63,
	0x12, 0x35, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x1f, 0x2e, 0x72, 0x69, 0x6c, 0x6c, 0x2e, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76,
	0x31, 0x2e, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x53, 0x74, 0x61, 0x74, 0x65,
	0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x22, 0xf1, 0x01, 0x0a, 0x0d, 0x43, 0x6f, 0x6e, 0x6e,
	0x65, 0x63, 0x74, 0x6f, 0x72, 0x53, 0x70, 0x65, 0x63, 0x12, 0x16, 0x0a, 0x06, 0x64, 0x72, 0x69,
	...
	,
	...
	0x4f, 0x44, 0x45, 0x5f, 0x52, 0x45, 0x53, 0x45, 0x54, 0x10, 0x01, 0x12, 0x1c, 0x0a, 0x18, 0x4d,
	0x4f, 0x44, 0x45, 0x4c, 0x5f, 0x43, 0x48, 0x41, 0x4e, 0x47, 0x45, 0x5f, 0x4d, 0x4f, 0x44, 0x45,
	0x5f, 0x4d, 0x41, 0x4e, 0x55, 0x41, 0x4c, 0x10, 0x02, 0x12, 0x1b, 0x0a, 0x17, 0x4d, 0x4f, 0x44,
	0x45, 0x4c, 0x5f, 0x43, 0x48, 0x41, 0x4e, 0x47, 0x45, 0x5f, 0x4d, 0x4f, 0x44, 0x45, 0x5f, 0x50,
	0x41, 0x54, 0x43, 0x48, 0x10, 0x03, 0x2a, 0xab, 0x01, 0x0a, 0x15, 0x45, 0x78, 0x70, 0x6c, 0x6f,
	0x72, 0x65, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x72, 0x69, 0x73, 0x6f, 0x6e, 0x4d, 0x6f, 0x64, 0x65,
...
var file_rill_runtime_v1_resources_proto_goTypes = []any{
	...
	(*MetricsViewSpec_RollupTable)(nil),       // 87: rill.runtime.v1.MetricsViewSpec.RollupTable
	(*MetricsViewSpec_RollupMeasure)(nil),     // 88: rill.runtime.v1.MetricsViewSpec.RollupMeasure
	nil,                                       // 89: rill.runtime.v1.ReportSpec.AnnotationsEntry
	nil,                                       // 90: rill.runtime.v1.AlertSpec.AnnotationsEntry
	nil,                                       // 91: rill.runtime.v1.ThemeColors.VariablesEntry
	nil,                                       // 92: rill.runtime.v1.CanvasPreset.FilterExprEntry
	...
	(*Type)(nil),                              // 101: rill.runtime.v1.Type
}
var file_rill_runtime_v1_resources_proto_depIdxs = []int32{
	...
	69,  // 13: rill.runtime.v1.Resource.api:type_name -> rill.runtime.v1.API
	78,  // 14: rill.runtime.v1.Resource.connector:type_name -> rill.runtime.v1.ConnectorV2
	...
	93,  // 18: rill.runtime.v1.ResourceMeta.created_on:type_name -> google.protobuf.Timestamp
	93,  // 19: rill.runtime.v1.ResourceMeta.spec_updated_on:type_name -> google.protobuf.Timestamp
	93,  // 20: rill.runtime.v1.ResourceMeta.state_updated_on:type_name -> google.protobuf.Timestamp
	93,  // 21: rill.runtime.v1.ResourceMeta.deleted_on:type_name -> google.protobuf.Timestamp
	0,   // 22: rill.runtime.v1.ResourceMeta.reconcile_status:type_name -> rill.runtime.v1.ReconcileStatus
	93,  // 23: rill.runtime.v1.ResourceMeta.reconcile_on:type_name -> google.protobuf.Timestamp
	...
	73,  // 27: rill.runtime.v1.ProjectParserState.parse_errors:type_name -> rill.runtime.v1.ParseError
	93,  // 28: rill.runtime.v1.ProjectParserState.current_commit_on:type_name -> google.protobuf.Timestamp
	...
	94,  // 31: rill.runtime.v1.SourceSpec.properties:type_name -> google.protobuf.Struct
	72,  // 32: rill.runtime.v1.SourceSpec.refresh_schedule:type_name -> rill.runtime.v1.Schedule
	93,  // 33: rill.runtime.v1.SourceState.refreshed_on:type_name -> google.protobuf.Timestamp
	...
	72,  // 36: rill.runtime.v1.ModelSpec.refresh_schedule:type_name -> rill.runtime.v1.Schedule
	94,  // 37: rill.runtime.v1.ModelSpec.incremental_state_resolver_properties:type_name -> google.protobuf.Struct
	94,  // 38: rill.runtime.v1.ModelSpec.partitions_resolver_properties:type_name -> google.protobuf.Struct
	94,  // 39: rill.runtime.v1.ModelSpec.input_properties:type_name -> google.protobuf.Struct
	94,  // 40: rill.runtime.v1.ModelSpec.stage_properties:type_name -> google.protobuf.Struct
	94,  // 41: rill.runtime.v1.ModelSpec.output_properties:type_name -> google.protobuf.Struct
	...
	94,  // 48: rill.runtime.v1.ModelTest.resolver_properties:type_name -> google.protobuf.Struct
	...
	96,  // 51: rill.runtime.v1.MetricsViewSpec.smallest_time_grain:type_name -> rill.runtime.v1.TimeGrain
	81,  // 52: rill.runtime.v1.MetricsViewSpec.dimensions:type_name -> rill.runtime.v1.MetricsViewSpec.Dimension
	84,  // 53: rill.runtime.v1.MetricsViewSpec.measures:type_name -> rill.runtime.v1.MetricsViewSpec.Measure
	...
	85,  // 56: rill.runtime.v1.MetricsViewSpec.annotations:type_name -> rill.runtime.v1.MetricsViewSpec.Annotation
	23,  // 57: rill.runtime.v1.MetricsViewSpec.security_rules:type_name -> rill.runtime.v1.SecurityRule
	86,  // 58: rill.runtime.v1.MetricsViewSpec.query_attributes:type_name -> rill.runtime.v1.MetricsViewSpec.QueryAttributesEntry
	87,  // 59: rill.runtime.v1.MetricsViewSpec.rollups:type_name -> rill.runtime.v1.MetricsViewSpec.RollupTable
	24,  // 60: rill.runtime.v1.SecurityRule.access:type_name -> rill.runtime.v1.SecurityRuleAccess
	25,  // 61: rill.runtime.v1.SecurityRule.field_access:type_name -> rill.runtime.v1.SecurityRuleFieldAccess
	26,  // 62: rill.runtime.v1.SecurityRule.row_filter:type_name -> rill.runtime.v1.SecurityRuleRowFilter
	27,  // 63: rill.runtime.v1.SecurityRule.transitive_access:type_name -> rill.runtime.v1.SecurityRuleTransitiveAccess
	10,  // 64: rill.runtime.v1.SecurityRuleAccess.condition_resources:type_name -> rill.runtime.v1.ResourceName
	10,  // 65: rill.runtime.v1.SecurityRuleFieldAccess.condition_resources:type_name -> rill.runtime.v1.ResourceName
	10,  // 66: rill.runtime.v1.SecurityRuleRowFilter.condition_resources:type_name -> rill.runtime.v1.ResourceName
	97,  // 67: rill.runtime.v1.SecurityRuleRowFilter.expression:type_name -> rill.runtime.v1.Expression
	10,  // 68: rill.runtime.v1.SecurityRuleTransitiveAccess.resource:type_name -> rill.runtime.v1.ResourceName
	22,  // 69: rill.runtime.v1.MetricsViewState.valid_spec:type_name -> rill.runtime.v1.MetricsViewSpec
	93,  // 70: rill.runtime.v1.MetricsViewState.data_refreshed_on:type_name -> google.protobuf.Timestamp
	30,  // 71: rill.runtime.v1.Explore.spec:type_name -> rill.runtime.v1.ExploreSpec
	31,  // 72: rill.runtime.v1.Explore.state:type_name -> rill.runtime.v1.ExploreState
	35,  // 73: rill.runtime.v1.ExploreSpec.dimensions_selector:type_name -> rill.runtime.v1.FieldSelector
	35,  // 74: rill.runtime.v1.ExploreSpec.measures_selector:type_name -> rill.runtime.v1.FieldSelector
	55,  // 75: rill.runtime.v1.ExploreSpec.embedded_theme:type_name -> rill.runtime.v1.ThemeSpec
	32,  // 76: rill.runtime.v1.ExploreSpec.time_ranges:type_name -> rill.runtime.v1.ExploreTimeRange
	34,  // 77: rill.runtime.v1.ExploreSpec.default_preset:type_name -> rill.runtime.v1.ExplorePreset
	23,  // 78: rill.runtime.v1.ExploreSpec.security_rules:type_name -> rill.runtime.v1.SecurityRule
	30,  // 79: rill.runtime.v1.ExploreState.valid_spec:type_name -> rill.runtime.v1.ExploreSpec
	93,  // 80: rill.runtime.v1.ExploreState.data_refreshed_on:type_name -> google.protobuf.Timestamp
	33,  // 81: rill.runtime.v1.ExploreTimeRange.comparison_time_ranges:type_name -> rill.runtime.v1.ExploreComparisonTimeRange
	35,  // 82: rill.runtime.v1.ExplorePreset.dimensions_selector:type_name -> rill.runtime.v1.FieldSelector
	35,  // 83: rill.runtime.v1.ExplorePreset.measures_selector:type_name -> rill.runtime.v1.FieldSelector
	97,  // 84: rill.runtime.v1.ExplorePreset.where:type_name -> rill.runtime.v1.Expression
	2,   // 85: rill.runtime.v1.ExplorePreset.comparison_mode:type_name -> rill.runtime.v1.ExploreComparisonMode
	3,   // 86: rill.runtime.v1.ExplorePreset.view:type_name -> rill.runtime.v1.ExploreWebView
	4,   // 87: rill.runtime.v1.ExplorePreset.explore_sort_type:type_name -> rill.runtime.v1.ExploreSortType
	36,  // 88: rill.runtime.v1.FieldSelector.fields:type_name -> rill.runtime.v1.StringListValue
	38,  // 89: rill.runtime.v1.Migration.spec:type_name -> rill.runtime.v1.MigrationSpec
	39,  // 90: rill.runtime.v1.Migration.state:type_name -> rill.runtime.v1.MigrationState
	41,  // 91: rill.runtime.v1.Report.spec:type_name -> rill.runtime.v1.ReportSpec
	42,  // 92: rill.runtime.v1.Report.state:type_name -> rill.runtime.v1.ReportState
	72,  // 93: rill.runtime.v1.ReportSpec.refresh_schedule:type_name -> rill.runtime.v1.Schedule
	94,  // 94: rill.runtime.v1.ReportSpec.resolver_properties:type_name -> google.protobuf.Struct
	98,  // 95: rill.runtime.v1.ReportSpec.export_format:type_name -> rill.runtime.v1.ExportFormat
	46,  // 96: rill.runtime.v1.ReportSpec.notifiers:type_name -> rill.runtime.v1.Notifier
	89,  // 97: rill.runtime.v1.ReportSpec.annotations:type_name -> rill.runtime.v1.ReportSpec.AnnotationsEntry
	93,  // 98: rill.runtime.v1.ReportState.next_run_on:type_name -> google.protobuf.Timestamp
	43,  // 99: rill.runtime.v1.ReportState.current_execution:type_name -> rill.runtime.v1.ReportExecution
	43,  // 100: rill.runtime.v1.ReportState.execution_history:type_name -> rill.runtime.v1.ReportExecution
	93,  // 101: rill.runtime.v1.ReportExecution.report_time:type_name -> google.protobuf.Timestamp
	93,  // 102: rill.runtime.v1.ReportExecution.started_on:type_name -> google.protobuf.Timestamp
	93,  // 103: rill.runtime.v1.ReportExecution.finished_on:type_name -> google.protobuf.Timestamp
	45,  // 104: rill.runtime.v1.Alert.spec:type_name -> rill.runtime.v1.AlertSpec
	47,  // 105: rill.runtime.v1.Alert.state:type_name -> rill.runtime.v1.AlertState
	72,  // 106: rill.runtime.v1.AlertSpec.refresh_schedule:type_name -> rill.runtime.v1.Schedule
	94,  // 107: rill.runtime.v1.AlertSpec.resolver_properties:type_name -> google.protobuf.Struct
	94,  // 108: rill.runtime.v1.AlertSpec.query_for_attributes:type_name -> google.protobuf.Struct
	46,  // 109: rill.runtime.v1.AlertSpec.notifiers:type_name -> rill.runtime.v1.Notifier
	90,  // 110: rill.runtime.v1.AlertSpec.annotations:type_name -> rill.runtime.v1.AlertSpec.AnnotationsEntry
	94,  // 111: rill.runtime.v1.Notifier.properties:type_name -> google.protobuf.Struct
	93,  // 112: rill.runtime.v1.AlertState.next_run_on:type_name -> google.protobuf.Timestamp
	48,  // 113: rill.runtime.v1.AlertState.current_execution:type_name -> rill.runtime.v1.AlertExecution
	48,  // 114: rill.runtime.v1.AlertState.execution_history:type_name -> rill.runtime.v1.AlertExecution
	49,  // 115: rill.runtime.v1.AlertExecution.result:type_name -> rill.runtime.v1.AssertionResult
	93,  // 116: rill.runtime.v1.AlertExecution.execution_time:type_name -> google.protobuf.Timestamp
	93,  // 117: rill.runtime.v1.AlertExecution.started_on:type_name -> google.protobuf.Timestamp
	93,  // 118: rill.runtime.v1.AlertExecution.finished_on:type_name -> google.protobuf.Timestamp
	93,  // 119: rill.runtime.v1.AlertExecution.suppressed_since:type_name -> google.protobuf.Timestamp
	5,   // 120: rill.runtime.v1.AssertionResult.status:type_name -> rill.runtime.v1.AssertionStatus
	94,  // 121: rill.runtime.v1.AssertionResult.fail_row:type_name -> google.protobuf.Struct
	51,  // 122: rill.runtime.v1.RefreshTrigger.spec:type_name -> rill.runtime.v1.RefreshTriggerSpec
	52,  // 123: rill.runtime.v1.RefreshTrigger.state:type_name -> rill.runtime.v1.RefreshTriggerState
	10,  // 124: rill.runtime.v1.RefreshTriggerSpec.resources:type_name -> rill.runtime.v1.ResourceName
	53,  // 125: rill.runtime.v1.RefreshTriggerSpec.models:type_name -> rill.runtime.v1.RefreshModelTrigger
	55,  // 126: rill.runtime.v1.Theme.spec:type_name -> rill.runtime.v1.ThemeSpec
	56,  // 127: rill.runtime.v1.Theme.state:type_name -> rill.runtime.v1.ThemeState
	99,  // 128: rill.runtime.v1.ThemeSpec.primary_color:type_name -> rill.runtime.v1.Color
	99,  // 129: rill.runtime.v1.ThemeSpec.secondary_color:type_name -> rill.runtime.v1.Color
	57,  // 130: rill.runtime.v1.ThemeSpec.light:type_name -> rill.runtime.v1.ThemeColors
	57,  // 131: rill.runtime.v1.ThemeSpec.dark:type_name -> rill.runtime.v1.ThemeColors
	91,  // 132: rill.runtime.v1.ThemeColors.variables:type_name -> rill.runtime.v1.ThemeColors.VariablesEntry
	59,  // 133: rill.runtime.v1.Component.spec:type_name -> rill.runtime.v1.ComponentSpec
	60,  // 134: rill.runtime.v1.Component.state:type_name -> rill.runtime.v1.ComponentState
	94,  // 135: rill.runtime.v1.ComponentSpec.renderer_properties:type_name -> google.protobuf.Struct
	61,  // 136: rill.runtime.v1.ComponentSpec.input:type_name -> rill.runtime.v1.ComponentVariable
	61,  // 137: rill.runtime.v1.ComponentSpec.output:type_name -> rill.runtime.v1.ComponentVariable
	59,  // 138: rill.runtime.v1.ComponentState.valid_spec:type_name -> rill.runtime.v1.ComponentSpec
	93,  // 139: rill.runtime.v1.ComponentState.data_refreshed_on:type_name -> google.protobuf.Timestamp
	100, // 140: rill.runtime.v1.ComponentVariable.default_value:type_name -> google.protobuf.Value
	63,  // 141: rill.runtime.v1.Canvas.spec:type_name -> rill.runtime.v1.CanvasSpec
	64,  // 142: rill.runtime.v1.Canvas.state:type_name -> rill.runtime.v1.CanvasState
	...
	67,  // 145: rill.runtime.v1.CanvasSpec.default_preset:type_name -> rill.runtime.v1.CanvasPreset
	61,  // 146: rill.runtime.v1.CanvasSpec.variables:type_name -> rill.runtime.v1.ComponentVariable
	65,  // 147: rill.runtime.v1.CanvasSpec.rows:type_name -> rill.runtime.v1.CanvasRow
	23,  // 148: rill.runtime.v1.CanvasSpec.security_rules:type_name -> rill.runtime.v1.SecurityRule
	63,  // 149: rill.runtime.v1.CanvasState.valid_spec:type_name -> rill.runtime.v1.CanvasSpec
	93,  // 150: rill.runtime.v1.CanvasState.data_refreshed_on:type_name -> google.protobuf.Timestamp
	66,  // 151: rill.runtime.v1.CanvasRow.items:type_name -> rill.runtime.v1.CanvasItem
	2,   // 152: rill.runtime.v1.CanvasPreset.comparison_mode:type_name -> rill.runtime.v1.ExploreComparisonMode
	92,  // 153: rill.runtime.v1.CanvasPreset.filter_expr:type_name -> rill.runtime.v1.CanvasPreset.FilterExprEntry
	97,  // 154: rill.runtime.v1.DefaultMetricsSQLFilter.expression:type_name -> rill.runtime.v1.Expression
	70,  // 155: rill.runtime.v1.API.spec:type_name -> rill.runtime.v1.APISpec
	71,  // 156: rill.runtime.v1.API.state:type_name -> rill.runtime.v1.APIState
	94,  // 157: rill.runtime.v1.APISpec.resolver_properties:type_name -> google.protobuf.Struct
	23,  // 158: rill.runtime.v1.APISpec.security_rules:type_name -> rill.runtime.v1.SecurityRule
	77,  // 159: rill.runtime.v1.ParseError.start_location:type_name -> rill.runtime.v1.CharLocation
	79,  // 160: rill.runtime.v1.ConnectorV2.spec:type_name -> rill.runtime.v1.ConnectorSpec
	80,  // 161: rill.runtime.v1.ConnectorV2.state:type_name -> rill.runtime.v1.ConnectorState
	94,  // 162: rill.runtime.v1.ConnectorSpec.properties:type_name -> google.protobuf.Struct
	94,  // 163: rill.runtime.v1.ConnectorSpec.provision_args:type_name -> google.protobuf.Struct
	6,   // 164: rill.runtime.v1.MetricsViewSpec.Dimension.type:type_name -> rill.runtime.v1.MetricsViewSpec.DimensionType
	96,  // 165: rill.runtime.v1.MetricsViewSpec.Dimension.smallest_time_grain:type_name -> rill.runtime.v1.TimeGrain
	101, // 166: rill.runtime.v1.MetricsViewSpec.Dimension.data_type:type_name -> rill.runtime.v1.Type
	96,  // 167: rill.runtime.v1.MetricsViewSpec.DimensionSelector.time_grain:type_name -> rill.runtime.v1.TimeGrain
	82,  // 168: rill.runtime.v1.MetricsViewSpec.MeasureWindow.order_by:type_name -> rill.runtime.v1.MetricsViewSpec.DimensionSelector
	7,   // 169: rill.runtime.v1.MetricsViewSpec.Measure.type:type_name -> rill.runtime.v1.MetricsViewSpec.MeasureType
	83,  // 170: rill.runtime.v1.MetricsViewSpec.Measure.window:type_name -> rill.runtime.v1.MetricsViewSpec.MeasureWindow
	82,  // 171: rill.runtime.v1.MetricsViewSpec.Measure.per_dimensions:type_name -> rill.runtime.v1.MetricsViewSpec.DimensionSelector
	...
	94,  // 173: rill.runtime.v1.MetricsViewSpec.Measure.format_d3_locale:type_name -> google.protobuf.Struct
	101, // 174: rill.runtime.v1.MetricsViewSpec.Measure.data_type:type_name -> rill.runtime.v1.Type
	35,  // 175: rill.runtime.v1.MetricsViewSpec.Annotation.measures_selector:type_name -> rill.runtime.v1.FieldSelector
	96,  // 176: rill.runtime.v1.MetricsViewSpec.RollupTable.time_grain:type_name -> rill.runtime.v1.TimeGrain
	88,  // 177: rill.runtime.v1.MetricsViewSpec.RollupTable.measures:type_name -> rill.runtime.v1.MetricsViewSpec.RollupMeasure
	68,  // 178: rill.runtime.v1.CanvasPreset.FilterExprEntry.value:type_name -> rill.runtime.v1.DefaultMetricsSQLFilter
...
func file_rill_runtime_v1_resources_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rill_runtime_v1_resources_proto_msgTypes[60].Exporter = func(v any, i int) any {
			switch v := v.(*DefaultMetricsSQLFilter); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_rill_runtime_v1_resources_proto_msgTypes[79].Exporter = func(v any, i int) any {
			switch v := v.(*MetricsViewSpec_RollupTable); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_rill_runtime_v1_resources_proto_msgTypes[80].Exporter = func(v any, i int) any {
			switch v := v.(*MetricsViewSpec_RollupMeasure); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
