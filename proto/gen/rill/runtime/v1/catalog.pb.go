...
func (Model_Dialect) Descriptor() protoreflect.EnumDescriptor {
	return file_rill_runtime_v1_catalog_proto_enumTypes[3].Descriptor()
}

func (Model_Dialect) Type() protoreflect.EnumType {
	return &file_rill_runtime_v1_catalog_proto_enumTypes[3]
}
...
type ModelMeta struct {
	...
	Access *ModelAccess `protobuf:"bytes,1,opt,name=access,proto3" json:"access,omitempty"`
}
...
func (x *ModelMeta) GetAccess() *ModelAccess {
	if x != nil {
		return x.Access
	}
	return nil
...
type ModelAccess struct {
	...
	Condition string          `protobuf:"bytes,1,opt,name=condition,proto3" json:"condition,omitempty"` // model access condition
	Filter    string          `protobuf:"bytes,2,opt,name=filter,proto3" json:"filter,omitempty"`       // row level filter expression
	Columns   []*ColumnAccess `protobuf:"bytes,3,rep,name=columns,proto3" json:"columns,omitempty"`     // column level access
}

func (x *ModelAccess) Reset() {
	*x = ModelAccess{}
	if protoimpl.UnsafeEnabled {
...
func (x *ModelAccess) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ModelAccess) ProtoMessage() {}

func (x *ModelAccess) ProtoReflect() protoreflect.Message {
	mi := &file_rill_runtime_v1_catalog_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ModelAccess.ProtoReflect.Descriptor instead.
func (*ModelAccess) Descriptor() ([]byte, []int) {
	return file_rill_runtime_v1_catalog_proto_rawDescGZIP(), []int{4}
}

func (x *ModelAccess) GetCondition() string {
	if x != nil {
		return x.Condition
	}
	return ""
...
func (x *ModelAccess) GetFilter() string {
	if x != nil {
		return x.Filter
	}
	return ""
...
func (x *ModelAccess) GetColumns() []*ColumnAccess {
	if x != nil {
		return x.Columns
	}
	return nil
...
type ColumnAccess struct {
	...
	Condition string `protobuf:"bytes,1,opt,name=condition,proto3" json:"condition,omitempty"` // column access condition
	Name      string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`           // column name
	Include   bool   `protobuf:"varint,3,opt,name=include,proto3" json:"include,omitempty"`    // include or exclude
}
...
func (*ColumnAccess) Descriptor() ([]byte, []int) {
	return file_rill_runtime_v1_catalog_proto_rawDescGZIP(), []int{5}
}

func (x *ColumnAccess) GetCondition() string {
	if x != nil {
		return x.Condition
	}
	return ""
...
func (x *ColumnAccess) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ColumnAccess) GetInclude() bool {
	if x != nil {
		return x.Include
	}
	return false
...
func (*MetricsView) Descriptor() ([]byte, []int) {
	return file_rill_runtime_v1_catalog_proto_rawDescGZIP(), []int{6}
}
...
func (x *MetricsView_Dimension) Reset() {
	*x = MetricsView_Dimension{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rill_runtime_v1_catalog_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MetricsView_Dimension) Descriptor() ([]byte, []int) {
	return file_rill_runtime_v1_catalog_proto_rawDescGZIP(), []int{6, 0}
}
...
func (x *MetricsView_Measure) Reset() {
	*x = MetricsView_Measure{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rill_runtime_v1_catalog_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MetricsView_Measure) Descriptor() ([]byte, []int) {
	return file_rill_runtime_v1_catalog_proto_rawDescGZIP(), []int{6, 1}
}
...
var file_rill_runtime_v1_catalog_proto_rawDesc = []byte{
	...
	,
	...
	0x69, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x69,
	0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x22, 0x9b, 0x05, 0x0a, 0x0b, 0x4d, 0x65, 0x74, 0x72, 0x69,
	...
	0x6d, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x46, 0x0a, 0x0a, 0x64, 0x69, 0x6d, 0x65, 0x6e,
	...
	0x73, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09,
	...
	0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x4a, 0x0a, 0x13, 0x73, 0x6d, 0x61,
	0x6c, 0x6c, 0x65, 0x73, 0x74, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x67, 0x72, 0x61, 0x69, 0x6e,
	0x18, 0x09, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x72, 0x69, 0x6c, 0x6c, 0x2e, 0x72, 0x75,
	...
	0x47, 0x72, 0x61, 0x69, 0x6e, 0x12, 0x2c, 0x0a, 0x12, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74,
	0x5f, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x72, 0x61, 0x6e, 0x67, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x10, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x52, 0x61,
	0x6e, 0x67, 0x65, 0x1a, 0x6f, 0x0a, 0x09, 0x44, 0x69, 0x6d, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e,
	...
	0x6c, 0x75, 0x6d, 0x6e, 0x1a, 0x8d, 0x01, 0x0a, 0x07, 0x4d, 0x65, 0x61, 0x73, 0x75, 0x72, 0x65,
	0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04,
	0x6e, 0x61, 0x6d, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x18, 0x02, 0x20,
	...
	0x72, 0x6d, 0x61, 0x74, 0x2a, 0x8d, 0x01, 0x0a, 0x0a, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x54,
	...
	,
...
var file_rill_runtime_v1_catalog_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_rill_runtime_v1_catalog_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_rill_runtime_v1_catalog_proto_goTypes = []interface{}{
	(ObjectType)(0),                    // 0: rill.runtime.v1.ObjectType
	(TimeGrain)(0),                     // 1: rill.runtime.v1.TimeGrain
	(Source_ExtractPolicy_Strategy)(0), // 2: rill.runtime.v1.Source.ExtractPolicy.Strategy
	(Model_Dialect)(0),                 // 3: rill.runtime.v1.Model.Dialect
	(*Table)(nil),                      // 4: rill.runtime.v1.Table
	(*Source)(nil),                     // 5: rill.runtime.v1.Source
	(*Model)(nil),                      // 6: rill.runtime.v1.Model
	(*ModelMeta)(nil),                  // 7: rill.runtime.v1.ModelMeta
	(*ModelAccess)(nil),                // 8: rill.runtime.v1.ModelAccess
	(*ColumnAccess)(nil),               // 9: rill.runtime.v1.ColumnAccess
	(*MetricsView)(nil),                // 10: rill.runtime.v1.MetricsView
	(*Source_ExtractPolicy)(nil),       // 11: rill.runtime.v1.Source.ExtractPolicy
	(*MetricsView_Dimension)(nil),      // 12: rill.runtime.v1.MetricsView.Dimension
	(*MetricsView_Measure)(nil),        // 13: rill.runtime.v1.MetricsView.Measure
	(*StructType)(nil),                 // 14: rill.runtime.v1.StructType
	(*structpb.Struct)(nil),            // 15: google.protobuf.Struct
}
var file_rill_runtime_v1_catalog_proto_depIdxs = []int32{
	14, // 0: rill.runtime.v1.Table.schema:type_name -> rill.runtime.v1.StructType
	15, // 1: rill.runtime.v1.Source.properties:type_name -> google.protobuf.Struct
	14, // 2: rill.runtime.v1.Source.schema:type_name -> rill.runtime.v1.StructType
	11, // 3: rill.runtime.v1.Source.policy:type_name -> rill.runtime.v1.Source.ExtractPolicy
	3,  // 4: rill.runtime.v1.Model.dialect:type_name -> rill.runtime.v1.Model.Dialect
	14, // 5: rill.runtime.v1.Model.schema:type_name -> rill.runtime.v1.StructType
	8,  // 6: rill.runtime.v1.ModelMeta.access:type_name -> rill.runtime.v1.ModelAccess
	9,  // 7: rill.runtime.v1.ModelAccess.columns:type_name -> rill.runtime.v1.ColumnAccess
	12, // 8: rill.runtime.v1.MetricsView.dimensions:type_name -> rill.runtime.v1.MetricsView.Dimension
	13, // 9: rill.runtime.v1.MetricsView.measures:type_name -> rill.runtime.v1.MetricsView.Measure
	1,  // 10: rill.runtime.v1.MetricsView.smallest_time_grain:type_name -> rill.runtime.v1.TimeGrain
	2,  // 11: rill.runtime.v1.Source.ExtractPolicy.rows_strategy:type_name -> rill.runtime.v1.Source.ExtractPolicy.Strategy
	2,  // 12: rill.runtime.v1.Source.ExtractPolicy.files_strategy:type_name -> rill.runtime.v1.Source.ExtractPolicy.Strategy
...
func file_rill_runtime_v1_catalog_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rill_runtime_v1_catalog_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rill_runtime_v1_catalog_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
