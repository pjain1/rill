 ...
 *
 * @generated from message rill.runtime.v1.GetProjectAccessRequest
 */
export class GetProjectAccessRequest extends Message<GetProjectAccessRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "rill.runtime.v1.GetProjectAccessRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "instance_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 *
 * @generated from message rill.runtime.v1.GetProjectAccessResponse
 */
export class GetProjectAccessResponse extends Message<GetProjectAccessResponse> {
  /**
   * @generated from field: rill.runtime.v1.ProjectAccess project_access = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "rill.runtime.v1.GetProjectAccessResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "project_access", kind: "message", T: ProjectAccess },
  ]);
...
/**
 * @generated from message rill.runtime.v1.ProjectAccess
 */
export class ProjectAccess extends Message<ProjectAccess> {
  /**
   * @generated from field: repeated rill.runtime.v1.Claims claims = 1;
   */
  claims: Claims[] = [];

  /**
   * @generated from field: string default_model_access = 2;
   */
  defaultModelAccess = "";

  constructor(data?: PartialMessage<ProjectAccess>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "rill.runtime.v1.ProjectAccess";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "claims", kind: "message", T: Claims, repeated: true },
    { no: 2, name: "default_model_access", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ProjectAccess {
    return new ProjectAccess().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ProjectAccess {
    return new ProjectAccess().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ProjectAccess {
    return new ProjectAccess().fromJsonString(jsonString, options);
  }

  static equals(a: ProjectAccess | PlainMessage<ProjectAccess> | undefined, b: ProjectAccess | PlainMessage<ProjectAccess> | undefined): boolean {
    return proto3.util.equals(ProjectAccess, a, b);
  }
}

/**
 * @generated from message rill.runtime.v1.Claims
 */
export class Claims extends Message<Claims> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "rill.runtime.v1.Claims";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
