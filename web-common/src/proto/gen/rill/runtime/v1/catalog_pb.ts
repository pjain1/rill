...
/**
 * @generated from message rill.runtime.v1.ModelMeta
 */
export class ModelMeta extends Message<ModelMeta> {
  /**
   * @generated from field: rill.runtime.v1.ModelAccess access = 1;
   */
  access?: ModelAccess;

  constructor(data?: PartialMessage<ModelMeta>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "rill.runtime.v1.ModelMeta";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "access", kind: "message", T: ModelAccess },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ModelMeta {
    return new ModelMeta().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ModelMeta {
    return new ModelMeta().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ModelMeta {
    return new ModelMeta().fromJsonString(jsonString, options);
  }

  static equals(a: ModelMeta | PlainMessage<ModelMeta> | undefined, b: ModelMeta | PlainMessage<ModelMeta> | undefined): boolean {
    return proto3.util.equals(ModelMeta, a, b);
  }
}

/**
 * @generated from message rill.runtime.v1.ModelAccess
 */
export class ModelAccess extends Message<ModelAccess> {
  /**
   * model access condition
   *
   ...
   * column level access
   *
   * @generated from field: repeated rill.runtime.v1.ColumnAccess columns = 3;
   */
  columns: ColumnAccess[] = [];

  constructor(data?: PartialMessage<ModelAccess>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "rill.runtime.v1.ModelAccess";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "condition", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "filter", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "columns", kind: "message", T: ColumnAccess, repeated: true },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ModelAccess {
    return new ModelAccess().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ModelAccess {
    return new ModelAccess().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ModelAccess {
    return new ModelAccess().fromJsonString(jsonString, options);
  }

  static equals(a: ModelAccess | PlainMessage<ModelAccess> | undefined, b: ModelAccess | PlainMessage<ModelAccess> | undefined): boolean {
    return proto3.util.equals(ModelAccess, a, b);
  }
}

/**
 * @generated from message rill.runtime.v1.ColumnAccess
 */
export class ColumnAccess extends Message<ColumnAccess> {
  /**
   * column access condition
   *
   * @generated from field: string condition = 1;
   */
  condition = "";
   ...
   * include or exclude
   *
   * @generated from field: bool include = 3;
   */
  include = false;

  constructor(data?: PartialMessage<ColumnAccess>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "rill.runtime.v1.ColumnAccess";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "condition", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "include", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ColumnAccess {
    return new ColumnAccess().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ColumnAccess {
    return new ColumnAccess().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ColumnAccess {
    return new ColumnAccess().fromJsonString(jsonString, options);
  }

  static equals(a: ColumnAccess | PlainMessage<ColumnAccess> | undefined, b: ColumnAccess | PlainMessage<ColumnAccess> | undefined): boolean {
    return proto3.util.equals(ColumnAccess, a, b);
  }
}
